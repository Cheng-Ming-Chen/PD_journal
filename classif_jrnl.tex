...
\captionsetup{font=footnotesize,singlelinecheck=false, justification=centering}
...
\newcommand{\domenico}[1]{{\color{blue}[DG: #1]}}
\newcommand{\vincent}[1]{{\color{brown}[VL: #1]}}
...
%
%\author{
 \author{Sreeraj~Rajendran,~\IEEEmembership{Student Member,~IEEE,}
        Wannes~Meert,~\IEEEmembership{Member,~IEEE}
        Domenico Giustiniano,~\IEEEmembership{Senior Member,~IEEE,}
        Vincent Lenders,~\IEEEmembership{Member,~IEEE}
...
\begin{IEEEkeywords}
Deep learning, Modulation classification, LSTM, CNN, Spectrum sensing.
\end{IEEEkeywords}
...
\section{Resource Friendly Models}
\label{lmodels}
\input{sections/lmodels}
